<template>
    <el-row>
        ...
        <el-col :span="18" style="height: 100%;">
                <div class='box2' v-if="data[0]">
                    <div class="rightTitle">新书速递</div>
                ...
                <div style="display: flex; width: 100%;justify-content: center;" v-if="!data[0]">
                    <h1>本月暂无新书录入，敬请期待......</h1>
...
import { getNewBookList } from '@/api/modules/books.js'
import { getBookCopyById } from '@/api/modules/bookCopy.js'
import { applyBorrow } from '@/api/modules/borrowRecordRequest.js'
